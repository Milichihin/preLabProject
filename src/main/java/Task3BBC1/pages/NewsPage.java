...
public class NewsPage extends BasePage {
    ...
    @FindBy(xpath = "(//a[@class='gs-c-section-link gs-c-section-link--truncate nw-c-section-link nw-o-link nw-o-link--no-visited-state'])[1]")
    private WebElement nameOfFirstCategory;
    ...
    public WebElement getNameOfFirstCategory() {
        return nameOfFirstCategory;
    }

    public final String getStringOfNameOfFirstCategory() {
        return getNameOfFirstCategory().getAttribute("textContent");
    }

    public void isNameOfFirstCategoryVisible() {
        getNameOfFirstCategory().isDisplayed();
    }
