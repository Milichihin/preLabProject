...
public class MessagePage extends BasePage {
    ...
    public void fillTheMultiFields(String field, String empty, List<WebElement> elemList, String qwerty) {
        ...
        WebElement emptyElem;

        switch (field) {
            case ("question"):
                emptyElem = getQuestionField();
                break;
            case ("email"):
                emptyElem = getEmailField();
                break;
            default:
                emptyElem = getNameField();
                break;
        }
    ...
    public List<WebElement> getElements () {
        ...
        el.add(getPhoneField());
        el.add(getLocationField());
        el.add(getAgeField());
        el.add(getQuestionField());
        el.add(getNameField());
        el.add(getEmailField());
        return el;
    }
